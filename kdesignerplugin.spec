...
%prep
%setup -q -n kdesignerplugin-5.87.0
cd %{_builddir}/kdesignerplugin-5.87.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634407273
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdesignerplugin-5.87.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kdesignerplugin/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
