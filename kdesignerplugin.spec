...
Version  : 5.106.0
Release  : 79
URL      : https://download.kde.org/stable/frameworks/5.106/portingAids/kdesignerplugin-5.106.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.106/portingAids/kdesignerplugin-5.106.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.106/portingAids/kdesignerplugin-5.106.0.tar.xz.sig
...
%prep
%setup -q -n kdesignerplugin-5.106.0
cd %{_builddir}/kdesignerplugin-5.106.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684947199
mkdir -p clr-build
pushd clr-build
