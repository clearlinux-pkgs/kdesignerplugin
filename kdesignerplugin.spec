...
Source0  : https://download.kde.org/stable/frameworks/5.52/kdesignerplugin-5.52.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.52/kdesignerplugin-5.52.0.tar.xz.sig
...
%prep
%setup -q -n kdesignerplugin-5.52.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1541867143
mkdir -p clr-build
pushd clr-build
%cmake ..
